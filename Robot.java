...
public class Robot extends SampleRobot {
	...
	public void operatorControl() {
		...
		while (isOperatorControl() && isEnabled()) {
			...
			compressorBoolean = controller1.getRawButton(1);
			
			if(compressorBoolean == true)
			{
...
//		THESE ARE USED TO MAKE THE PRESSURE SWITCH WORK	
//			boolean enabled = c.enabled();
//			boolean current = c.getClosedLoopControl();
		}
	}
